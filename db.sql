...
CREATE TABLE `users` (
    ...
    `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT "" COMMENT '电话号',
    `country` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT "" COMMENT '国家',
...
INSERT INTO `users` VALUES (1, 'user', '12345678', 'user@qq.com', 'zzz', 0, '/img/avatar/default.jpg', '13588763355', '中国', '山东', '青岛');
INSERT INTO `users` VALUES (NULL, 'user2', '12345678', 'user2@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user3', '12345678', 'user2@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user4', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user5', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user6', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user7', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user8', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user9', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user10', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user11', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user12', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user13', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user14', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user15', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user16', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `users` VALUES (NULL, 'user17', '12345678', 'user@163.com', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);    
